  ...
  slides:any[] = [
    ...
    {title:"Обработка зерна", first:{
      title:"Сухая обработка", description:"Ягоды сушат на&nbsp;бетонных, глиняных патио или просто на&nbsp;земле", list:[
        ...
        {color:"#EC8B96", marker:"-", text:"риск получить землистый привкус"}
      ]
    }, second:{
    ...
    }, end:"Система Nespresso позволяет использовать различные виды помола внутри капсул. Благодаря этому во&nbsp;время экстракции возможно раскрыть индивидуальные особенности каждого сорта кофе, подбирая индивидуальную технику помола."}
  ];
